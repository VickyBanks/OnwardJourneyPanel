...
ggplot(clickPlacementComparison, aes(x = clickGroup, y = perc, fill = clickGroup)) +
  ...
  scale_fill_manual(values = c("#043570", "#037301"), name = "Click Group", labels = c("All Content", "Nav Click Content"))+
